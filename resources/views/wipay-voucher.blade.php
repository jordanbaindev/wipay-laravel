            ...
            <div class="bg-white pb-8 pt-4 px-4 shadow sm:rounded-lg sm:px-10">
                <form id="form" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="order_id" name="order_id" type="hidden" value="{{ request()->order_id }}"/>
                            <input id="customer_id" name="customer_id" type="hidden" value="{{ request()->customer_id }}"/>
    ...
    <div id="modal" class="hidden relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <div class="mt-5 sm:mt-4 sm:ml-10 sm:flex sm:pl-4">
                ...
                <button id="retryButton" type="button" class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Retry</button>
            </div>
            </div>
        </div>
        </div>
...
<script>
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('{{ route('wipay.process-voucher') }}', {
            method: 'POST',
            body: payload,
        })
            .then((response) => {
